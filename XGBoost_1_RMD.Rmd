...
```{r}
sum_CL <- summary(new_df$Cutaneous.Leishmaniasis[new_df$Cutaneous.Leishmaniasis > 0]) # very important step to get right, otherwise it might nullify model adequacy (most criticism may come from this step - make sure to justify)
...
cat_df$Cutaneous.Leishmaniasis <- cut(cat_df$Cutaneous.Leishmaniasis,
                                      breaks = c(-1, 0.09203, 0.87690, 10^3), # -1 instead of 0
                                                                               # since noninclusive
