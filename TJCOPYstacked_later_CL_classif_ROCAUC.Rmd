...
save(Index_temp, file = 'models/stacking/TEMP_Index_temp')
data_test_30 <-  (aad %>% 
...
save(svm_res, file = 'models/stacking/TEMP_svm_res_later_CL_classif_30')
...
save(xgb_res, file = 'models/stacking/TEMP_xgb_res_later_CL_classif_30')
...
save(rf_res, file = 'models/stacking/TEMP_rf_res_later_CL_classif_30')
# 
...
save(nb_res, file = 'models/stacking/TEMP_nb_res_later_CL_classif_30')
```

Finally, we build our stacked model based on the best performing base model candidates.

```{r}
load(file = 'models/stacking/TEMP_svm_res_later_CL_classif_30')
load(file = 'models/stacking/TEMP_xgb_res_later_CL_classif_30')
load(file = 'models/stacking/TEMP_rf_res_later_CL_classif_30')
load(file = 'models/stacking/TEMP_nb_res_later_CL_classif_30')
...
save(data_st_30, file = 'models/stacking/TEMP_data_st_later_CL_classif_30')
...
save(model_st_30, file = 'models/stacking/TEMP_model_st_later_CL_classif_30')
load('models/stacking/TEMP_model_st_later_CL_classif_30')
...
save(data_test_30, file = 'models/stacking/TEMP_data_test_later_CL_classif_30')
...
save(conf_mat_later_CL_classif_30, file = 'models/stacking/TEMP_conf_mat_later_CL_classif_30')
...
save(svm_res, file = 'models/stacking/TEMP_svm_res_later_CL_classif_40')
...
save(xgb_res, file = 'models/stacking/TEMP_xgb_res_later_CL_classif_40')
# 
...
save(rf_res, file = 'models/stacking/TEMP_rf_res_later_CL_classif_40')
# 
...
save(nb_res, file = 'models/stacking/TEMP_nb_res_later_CL_classif_40')

load(file = 'models/stacking/TEMP_svm_res_later_CL_classif_40')
load(file = 'models/stacking/TEMP_xgb_res_later_CL_classif_40')
load(file = 'models/stacking/TEMP_rf_res_later_CL_classif_40')
load(file = 'models/stacking/TEMP_nb_res_later_CL_classif_40')
...
save(data_st_40, file = 'models/stacking/TEMP_data_st_later_CL_classif_40')
load('models/stacking/TEMP_data_st_later_CL_classif_40')
...
save(model_st_40, file = 'models/stacking/TEMP_model_st_later_CL_classif_40')

load('models/stacking/TEMP_model_st_later_CL_classif_40')

data_test_40 <-
  data_test_40 %>%
  bind_cols(predict(model_st_40, .))

save(data_test_40, file = 'models/stacking/TEMP_data_test_later_CL_classif_40')
load('models/stacking/TEMP_data_test_later_CL_classif_40')
...
save(conf_mat_later_CL_classif_40, file = 'models/stacking/TEMP_conf_mat_later_CL_classif_40')
...
load('./data/imp')
aad <- read_csv('models/data/aad.csv')
load('models/stacking/TEMP_Index_temp')
...
save(svm_res, file = 'models/stacking/TEMP_svm_res_later_CL_classif_50')
...
save(xgb_res, file = 'models/stacking/TEMP_xgb_res_later_CL_classif_50')
# 
...
save(rf_res, file = 'models/stacking/TEMP_rf_res_later_CL_classif_50')
# 
...
save(nb_res, file = 'models/stacking/TEMP_nb_res_later_CL_classif_50')

load(file = 'models/stacking/TEMP_svm_res_later_CL_classif_50')
load(file = 'models/stacking/TEMP_xgb_res_later_CL_classif_50')
load(file = 'models/stacking/TEMP_rf_res_later_CL_classif_50')
load(file = 'models/stacking/TEMP_nb_res_later_CL_classif_50')
...
save(data_st_50, file = 'models/stacking/TEMP_data_st_later_CL_classif_50')
...
save(model_st_50, file = 'models/stacking/TEMP_model_st_later_CL_classif_50')
load('models/stacking/TEMP_model_st_later_CL_classif_50')
...
save(data_test_50, file = 'models/stacking/TEMP_data_test_later_CL_classif_50')
...
save(conf_mat_later_CL_classif_50, file = 'models/stacking/TEMP_conf_mat_later_CL_classif_50')
...
save(svm_res, file = 'models/stacking/TEMP_svm_res_later_CL_classif_60')
...
save(xgb_res, file = 'models/stacking/TEMP_xgb_res_later_CL_classif_60')
# 
...
save(rf_res, file = 'models/stacking/TEMP_rf_res_later_CL_classif_60')
# 
...
save(nb_res, file = 'models/stacking/TEMP_nb_res_later_CL_classif_60')

load(file = 'models/stacking/TEMP_svm_res_later_CL_classif_60')
load(file = 'models/stacking/TEMP_xgb_res_later_CL_classif_60')
load(file = 'models/stacking/TEMP_rf_res_later_CL_classif_60')
load(file = 'models/stacking/TEMP_nb_res_later_CL_classif_60')
...
save(data_st_60, file = 'models/stacking/TEMP_data_st_later_CL_classif_60')
...
save(model_st_60, file = 'models/stacking/TEMP_model_st_later_CL_classif_60')
load('models/stacking/TEMP_model_st_later_CL_classif_60')
...
save(data_test_60, file = 'models/stacking/TEMP_data_test_later_CL_classif_60')
...
save(conf_mat_later_CL_classif_60, file = 'models/stacking/TEMP_conf_mat_later_CL_classif_60')
...
save(svm_res, file = 'models/stacking/TEMP_svm_res_later_CL_classif_70')
...
save(xgb_res, file = 'models/stacking/TEMP_xgb_res_later_CL_classif_70')
# 
...
save(rf_res, file = 'models/stacking/TEMP_rf_res_later_CL_classif_70')
# 
...
save(nb_res, file = 'models/stacking/TEMP_nb_res_later_CL_classif_70')

load(file = 'models/stacking/TEMP_svm_res_later_CL_classif_70')
load(file = 'models/stacking/TEMP_xgb_res_later_CL_classif_70')
load(file = 'models/stacking/TEMP_rf_res_later_CL_classif_70')
load(file = 'models/stacking/TEMP_nb_res_later_CL_classif_70')
...
save(data_st_70, file = 'models/stacking/TEMP_data_st_later_CL_classif_70')
...
save(model_st_70, file = 'models/stacking/TEMP_model_st_later_CL_classif_70')
load('models/stacking/TEMP_model_st_later_CL_classif_70')
...
save(data_test_70, file = 'models/stacking/TEMP_data_test_later_CL_classif_70')
...
save(conf_mat_later_CL_classif_70, file = 'models/stacking/TEMP_conf_mat_later_CL_classif_70')
...
load(file = 'models/stacking/TEMP_conf_mat_later_CL_classif_30')
load(file = 'models/stacking/TEMP_conf_mat_later_CL_classif_40')
load(file = 'models/stacking/TEMP_conf_mat_later_CL_classif_50')
load(file = 'models/stacking/TEMP_conf_mat_later_CL_classif_60')
load(file = 'models/stacking/TEMP_conf_mat_later_CL_classif_70')
```
...
load(file = 'models/stacking/TEMP_data_test_later_CL_classif_30')
load(file = 'models/stacking/TEMP_data_test_later_CL_classif_40')
load(file = 'models/stacking/TEMP_data_test_later_CL_classif_50')
load(file = 'models/stacking/TEMP_data_test_later_CL_classif_60')
load(file = 'models/stacking/TEMP_data_test_later_CL_classif_70')
...
save(heatmap_aad, file = "models/stacking/TEMP_heatmap_aad")
...
save(heatmap_mis_40, file = "models/stacking/TEMP_heatmap_mis_40")
...
save(heatmap_correct_40, file = "models/stacking/TEMP_heatmap_correct_40")
```

```{r heatmaps, eval=T}
load("models/stacking/TEMP_heatmap_aad")
load("models/stacking/TEMP_heatmap_mis_40")
load("models/stacking/TEMP_heatmap_correct_40")
