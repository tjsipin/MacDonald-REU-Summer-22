...
load('models/stacking/model_st_early_CL_classif_30')
...
save(data_test_30, file = 'models/stacking/data_test_early_CL_classif_30')
...
load('models/stacking/data_st_early_CL_classif_40')
...
load('models/stacking/model_st_early_CL_classif_40')
...
load('models/stacking/model_st_early_CL_classif_50')
...
load('models/stacking/model_st_early_CL_classif_60')
...
load('models/stacking/model_st_early_CL_classif_70')
...
```{r}
load("models/stacking/svm_res_early_CL_classif_40")
load("models/stacking/rf_res_early_CL_classif_40")
load("models/stacking/xgb_res_early_CL_classif_40")
load("models/stacking/nb_res_early_CL_classif_40")

library(e1071)
library(kernlab)

svm_radial_fit <- svm_res %>% 
  fit(Cutaneous.Leishmaniasis ~ ., data = data_test_40 %>% select(-c(.pred_class)))
