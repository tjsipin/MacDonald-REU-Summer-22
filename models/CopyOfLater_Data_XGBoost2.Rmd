...
`Later_Data_XGBoost2.Rmd` but with NAs of forest not removed, instead set to 0.
...
cat_df$Cutaneous.Leishmaniasis <- cut(later_data_small$Cutaneous.Leishmaniasis, breaks = c(0, 0.2817695, 10^3), labels = c("low", "high")) # median
