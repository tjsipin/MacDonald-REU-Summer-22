...
save(svm_res, file = 'models/stacking/svm_res_early_reg')
load(file = 'models/stacking/svm_res_early_reg')
...
save(xgb_res, file = 'models/stacking/xgb_res_early_reg')

# load(file = 'models/stacking/xgb_res_early_reg')
...
save(rf_res, file = 'models/stacking/rf_res_early_reg')

# load(file = 'models/stacking/rf_res_early_reg')
