...
Index_temp_30 <- as.numeric(rownames(data_test_30_temp))
save(Index_temp_30, file = 'Index_temp_30_later_CL')
load(file = 'Index_temp_30_later_CL')
data_test_30 <-  (aad %>% 
                    dplyr::select(c(colnames(data_test_30_temp))))[Index_temp_30,] %>% 
...
Index_temp_50 <- as.numeric(rownames(data_test_50_temp))


data_test_50 <-  (aad %>% 
                    dplyr::select(c(colnames(data_test_50_temp))))[Index_temp_50,] %>% 
  subset(!is.na(LST_Day)) %>% 
  subset(!is.na(SWOccurrence))
...
Index_temp_60 <- as.numeric(rownames(data_test_60_temp))


data_test_60 <-  (aad %>% 
                    dplyr::select(c(colnames(data_test_60_temp))))[Index_temp_60,] %>% 
  subset(!is.na(LST_Day)) %>% 
  subset(!is.na(SWOccurrence))
