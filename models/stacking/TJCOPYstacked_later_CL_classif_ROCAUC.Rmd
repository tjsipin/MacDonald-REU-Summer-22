---
title: "stacked_later_CL_classif_ROCAUC"
author: "TJ Sipin"
date: "`r Sys.Date()`"
...
data <- data %>%
  ...
  dplyr::select(c('Cutaneous.Leishmaniasis', 'LST_Day', 'Year', # include LST_Night?
                  ...
                  'te_forest', 'enn_mn_forest', 'area_mn_forest',
                  'Population'))
...
data$area_mn_forest <- ifelse(is.na(data$area_mn_forest), 0, data$area_mn_forest)
...
save(Index_temp, file = 'TEMP_Index_temp')
data_test_30 <-  (aad %>% 
                    select(c(colnames(data_test_30_temp))))[Index_temp,] %>% 
...
data_test_30$area_mn_forest <- ifelse(is.na(data_test_30$area_mn_forest), 0, data_test_30$area_mn_forest)
...
data_rec <-
  recipe(Cutaneous.Leishmaniasis ~ LST_Day + Year + NDVI + 
           ...
           te_forest + area_mn_forest + enn_mn_forest + Population, data = data_train) %>%
...
save(svm_res, file = 'base_models/TEMP_svm_res_later_CL_classif_30')
...
save(xgb_res, file = 'base_models/TEMP_xgb_res_later_CL_classif_30')
...
save(rf_res, file = 'base_models/TEMP_rf_res_later_CL_classif_30')
# 
...
save(nb_res, file = 'base_models/TEMP_nb_res_later_CL_classif_30')
```

Finally, we build our stacked model based on the best performing base model candidates.

```{r}
load(file = 'base_models/TEMP_svm_res_later_CL_classif_30')
load(file = 'base_models/TEMP_xgb_res_later_CL_classif_30')
load(file = 'base_models/TEMP_rf_res_later_CL_classif_30')
load(file = 'base_models/TEMP_nb_res_later_CL_classif_30')
...
save(data_st_30, file = 'data_stacks/TEMP_data_st_later_CL_classif_30')
...
save(model_st_30, file = 'model_stacks/TEMP_model_st_later_CL_classif_30')
load('model_stacks/TEMP_model_st_later_CL_classif_30')
...
save(data_test_30, file = 'data_tests/TEMP_data_test_later_CL_classif_30')


# confusion matrix for stacks
conf_mat_later_CL_classif_30 <- caret::confusionMatrix(data = data_test_30$.pred_class, 
                                                       reference = data_test_30$Cutaneous.Leishmaniasis,
                                                       positive = '1')

save(conf_mat_later_CL_classif_30, file = 'confusion_matrices/TEMP_conf_mat_later_CL_classif_30')
...
data_test_40$area_mn_forest <- ifelse(is.na(data_test_40$area_mn_forest), 0, data_test_40$area_mn_forest)
...
```{r}
ggplot(data_test_40 %>% filter(te_forest > 0)) +
  geom_boxplot(aes(x = Cutaneous.Leishmaniasis,
               y = te_forest,
               color = .pred_class),
               alpha = 0.1)
```
...
data_test_50 <-  (aad %>% 
                    select(c(colnames(data_test_50_temp))))[Index_temp,] %>% 
  subset(!is.na(LST_Day)) %>% 
  subset(!is.na(SWOccurrence))


data_test_50$pland_forest <- ifelse(is.na(data_test_50$pland_forest), 0, data_test_50$pland_forest)
data_test_50$te_forest <- ifelse(is.na(data_test_50$te_forest), 0, data_test_50$te_forest)
data_test_50$enn_mn_forest <- ifelse(is.na(data_test_50$enn_mn_forest), 0, data_test_50$enn_mn_forest)
data_test_50$area_mn_forest <- ifelse(is.na(data_test_50$area_mn_forest), 0, data_test_50$area_mn_forest)
...
save(svm_res, file = 'base_models/TEMP_svm_res_later_CL_classif_50')
...
save(xgb_res, file = 'base_models/TEMP_xgb_res_later_CL_classif_50')
# 
...
save(rf_res, file = 'base_models/TEMP_rf_res_later_CL_classif_50')
# 
...
save(nb_res, file = 'base_models/TEMP_nb_res_later_CL_classif_50')

load(file = 'base_models/TEMP_svm_res_later_CL_classif_50')
load(file = 'base_models/TEMP_xgb_res_later_CL_classif_50')
load(file = 'base_models/TEMP_rf_res_later_CL_classif_50')
load(file = 'base_models/TEMP_nb_res_later_CL_classif_50')
...
save(data_st_50, file = 'data_stacks/TEMP_data_st_later_CL_classif_50')
...
save(model_st_50, file = 'model_stacks/TEMP_model_st_later_CL_classif_50')
load('model_stacks/TEMP_model_st_later_CL_classif_50')
...
save(data_test_50, file = 'data_tests/TEMP_data_test_later_CL_classif_50')


# confusion matrix for stacks
conf_mat_later_CL_classif_50 <- caret::confusionMatrix(data = data_test_50$.pred_class, 
                                                       reference = data_test_50$Cutaneous.Leishmaniasis,
                                                       positive = '1')

save(conf_mat_later_CL_classif_50, file = 'confusion_matrices/TEMP_conf_mat_later_CL_classif_50')
...
data_test_60 <-  (aad %>% 
                    select(c(colnames(data_test_60_temp))))[Index_temp,] %>% 
  subset(!is.na(LST_Day)) %>% 
  subset(!is.na(SWOccurrence))


data_test_60$pland_forest <- ifelse(is.na(data_test_60$pland_forest), 0, data_test_60$pland_forest)
data_test_60$te_forest <- ifelse(is.na(data_test_60$te_forest), 0, data_test_60$te_forest)
data_test_60$enn_mn_forest <- ifelse(is.na(data_test_60$enn_mn_forest), 0, data_test_60$enn_mn_forest)
data_test_60$area_mn_forest <- ifelse(is.na(data_test_60$area_mn_forest), 0, data_test_60$area_mn_forest)
...
save(svm_res, file = 'base_models/TEMP_svm_res_later_CL_classif_60')
...
save(xgb_res, file = 'base_models/TEMP_xgb_res_later_CL_classif_60')
# 
...
save(rf_res, file = 'base_models/TEMP_rf_res_later_CL_classif_60')
# 
...
save(nb_res, file = 'base_models/TEMP_nb_res_later_CL_classif_60')

load(file = 'base_models/TEMP_svm_res_later_CL_classif_60')
load(file = 'base_models/TEMP_xgb_res_later_CL_classif_60')
load(file = 'base_models/TEMP_rf_res_later_CL_classif_60')
load(file = 'base_models/TEMP_nb_res_later_CL_classif_60')
...
save(data_st_60, file = 'data_stacks/TEMP_data_st_later_CL_classif_60')
...
save(model_st_60, file = 'model_stacks/TEMP_model_st_later_CL_classif_60')
load('model_stacks/TEMP_model_st_later_CL_classif_60')
...
save(data_test_60, file = 'data_tests/TEMP_data_test_later_CL_classif_60')


# confusion matrix for stacks
conf_mat_later_CL_classif_60 <- caret::confusionMatrix(data = data_test_60$.pred_class, 
                                                       reference = data_test_60$Cutaneous.Leishmaniasis,
                                                       positive = '1')

save(conf_mat_later_CL_classif_60, file = 'confusion_matrices/TEMP_conf_mat_later_CL_classif_60')
...
data_test_70 <-  (aad %>% 
                    select(c(colnames(data_test_70_temp))))[Index_temp,] %>% 
  subset(!is.na(LST_Day)) %>% 
  subset(!is.na(SWOccurrence))
...
data_test_70$area_mn_forest <- ifelse(is.na(data_test_70$area_mn_forest), 0, data_test_70$area_mn_forest)
...
save(svm_res, file = 'base_models/TEMP_svm_res_later_CL_classif_70')
...
save(xgb_res, file = 'base_models/TEMP_xgb_res_later_CL_classif_70')
# 
...
save(rf_res, file = 'base_models/TEMP_rf_res_later_CL_classif_70')
# 
...
save(nb_res, file = 'base_models/TEMP_nb_res_later_CL_classif_70')

load(file = 'base_models/TEMP_svm_res_later_CL_classif_70')
load(file = 'base_models/TEMP_xgb_res_later_CL_classif_70')
load(file = 'base_models/TEMP_rf_res_later_CL_classif_70')
load(file = 'base_models/TEMP_nb_res_later_CL_classif_70')
...
save(data_st_70, file = 'data_stacks/TEMP_data_st_later_CL_classif_70')
...
save(model_st_70, file = 'model_stacks/TEMP_model_st_later_CL_classif_70')
load('model_stacks/TEMP_model_st_later_CL_classif_70')
...
save(data_test_70, file = 'data_tests/TEMP_data_test_later_CL_classif_70')
...
save(conf_mat_later_CL_classif_70, file = 'confusion_matrices/TEMP_conf_mat_later_CL_classif_70')
...
load(file = 'confusion_matrices/TEMP_conf_mat_later_CL_classif_30')
load(file = 'confusion_matrices/TEMP_conf_mat_later_CL_classif_40')
load(file = 'confusion_matrices/TEMP_conf_mat_later_CL_classif_50')
load(file = 'confusion_matrices/TEMP_conf_mat_later_CL_classif_60')
load(file = 'confusion_matrices/TEMP_conf_mat_later_CL_classif_70')
```
...
conf_mat_later_CL_classif_30[1:4]
```

### 40th percentile
```{r, echo=F, eval=T}
conf_mat_later_CL_classif_40[1:4]
```

### 50th percentile
```{r, echo=F, eval=T}
conf_mat_later_CL_classif_50[1:4]
```

### 60th percentile
```{r, echo=F, eval=T}
conf_mat_later_CL_classif_60[1:4]
```

### 70th percentile
```{r, echo=F, eval=T}
conf_mat_later_CL_classif_70[1:4]
```
...
load(file = 'data_tests/TEMP_data_test_later_CL_classif_30')
load(file = 'data_tests/TEMP_data_test_later_CL_classif_40')
load(file = 'data_tests/TEMP_data_test_later_CL_classif_50')
load(file = 'data_tests/TEMP_data_test_later_CL_classif_60')
load(file = 'data_tests/TEMP_data_test_later_CL_classif_70')
...
save(heatmap_aad, file = "heatmaps/TEMP_heatmap_aad")
...
save(heatmap_mis_40, file = "heatmaps/TEMP_heatmap_mis_40")
...
save(heatmap_correct_40, file = "heatmaps/TEMP_heatmap_correct_40")
```

```{r heatmaps, eval=T}
load("heatmaps/TEMP_heatmap_aad")
load("heatmaps/TEMP_heatmap_mis_40")
load("heatmaps/TEMP_heatmap_correct_40")
