...
data <- data %>%
  ...
  filter(!is.na(Cutaneous.Leishmaniasis)) %>% 
  filter(Cutaneous.Leishmaniasis > 0) %>%
  dplyr::select(c('Cutaneous.Leishmaniasis', 'Year', 'LST_Day', # include LST_Night?
                  'NDVI', 'EVI', 'Precip', 
...
save(conf_mat_early_CL_classif_30, file = 'conf_mats/conf_mat_early_CL_classif_30')
...
save(conf_mat_early_CL_classif_40, file = 'conf_mats/conf_mat_early_CL_classif_40')
...
save(conf_mat_early_CL_classif_50, file = 'conf_mats/conf_mat_early_CL_classif_50')
...
save(conf_mat_early_CL_classif_60, file = 'conf_mats/conf_mat_early_CL_classif_60')
...
save(conf_mat_early_CL_classif_70, file = 'conf_mats/conf_mat_early_CL_classif_70')
...
load(file = 'conf_mats/conf_mat_early_CL_classif_30')
load(file = 'conf_mats/conf_mat_early_CL_classif_40')
load(file = 'conf_mats/conf_mat_early_CL_classif_50')
load(file = 'conf_mats/conf_mat_early_CL_classif_60')
load(file = 'conf_mats/conf_mat_early_CL_classif_70')
```
...
save(heatmap_aad, file = "heatmap_aad")
...
save(heatmap_mis_40, file = "heatmap_mis_40")
...
save(heatmap_correct_40, file = "heatmap_correct_40")
```

```{r heatmaps, eval=T}
load("heatmap_aad")
load("heatmap_mis_40")
load("heatmap_correct_40")
