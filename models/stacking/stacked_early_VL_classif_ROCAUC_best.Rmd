...
*Note: all of the target variables are diseases, such as visceral leishmaniasis, the primary target variable of interest in this report.*
...
data_test_30$Visceral.Leishmaniasis <- as.factor(ifelse(data_test_30$Visceral.Leishmaniasis < quantile, 0, 1))
...
explanatory = c('LST_Day', # include LST_Night?
                  ...
                  'StableLights', 'SWOccurrence', 'pland_forest',
                  'te_forest', 'enn_mn_forest','Population')
dependent = 'Visceral.Leishmaniasis'
data_test_30_2 %>% 
...
save(model_st_30, file = 'model_stacks/model_st_early_VL_classif_30')
load('model_stacks/model_st_early_VL_classif_30')
...
save(conf_mat_early_VL_classif_30, file = 'conf_mats/conf_mat_early_VL_classif_30')
...
data_test_40$Visceral.Leishmaniasis <- as.factor(ifelse(data_test_40$Visceral.Leishmaniasis < quantile, 0, 1))
...
load('data_stacks/data_st_early_VL_classif_40')
...
save(model_st_40, file = 'model_stacks/model_st_early_VL_classif_40')

load('model_stacks/model_st_early_VL_classif_40')
...
save(conf_mat_early_VL_classif_40, file = 'conf_mats/conf_mat_early_VL_classif_40')
...
data_test_50$Visceral.Leishmaniasis <- as.factor(ifelse(data_test_50$Visceral.Leishmaniasis < quantile, 0, 1))
...
save(model_st_50, file = 'model_stacks/model_st_early_VL_classif_50')
load('model_stacks/model_st_early_VL_classif_50')
...
save(conf_mat_early_VL_classif_50, file = 'conf_mats/conf_mat_early_VL_classif_50')
...
data_test_60$Visceral.Leishmaniasis <- as.factor(ifelse(data_test_60$Visceral.Leishmaniasis < quantile, 0, 1))
...
save(model_st_60, file = 'model_stacks/model_st_early_VL_classif_60')
load('model_stacks/model_st_early_VL_classif_60')
...
save(conf_mat_early_VL_classif_60, file = 'conf_mats/conf_mat_early_VL_classif_60')
...
data_test_70$Visceral.Leishmaniasis <- as.factor(ifelse(data_test_70$Visceral.Leishmaniasis < quantile, 0, 1))
...
save(model_st_70, file = 'model_stacks/model_st_early_VL_classif_70')
load('model_stacks/model_st_early_VL_classif_70')
...
save(conf_mat_early_VL_classif_70, file = 'conf_mats/conf_mat_early_VL_classif_70')
...
load(file = 'conf_mats/conf_mat_early_VL_classif_30')
load(file = 'conf_mats/conf_mat_early_VL_classif_40')
load(file = 'conf_mats/conf_mat_early_VL_classif_50')
load(file = 'conf_mats/conf_mat_early_VL_classif_60')
load(file = 'conf_mats/conf_mat_early_VL_classif_70')
```
...
### 40th percentile
```{r, echo=F, eval=T}
conf_mat_early_VL_classif_40[1:4]
```

### 50th percentile
```{r, echo=F, eval=T}
conf_mat_early_VL_classif_50[1:4]
```

### 60th percentile
```{r, echo=F, eval=T}
conf_mat_early_VL_classif_60[1:4]
```

### 70th percentile
```{r, echo=F, eval=T}
conf_mat_early_VL_classif_70[1:4]
```
...
```{r roc auc graphs, eval=T, echo=F}
library(tidyverse)
library(pROC)
library(dplyr)
library(ggplot2)
...
```{r, eval=T, echo=F}
# to get true levels of VL again
...
aad <- read_csv('../data/aad.csv')
aad_clean <- (aad %>% 
          select(c(Visceral.Leishmaniasis, LST_Day, NDVI,
  ...
  subset(!is.na(Visceral.Leishmaniasis)) %>% 
  subset(Visceral.Leishmaniasis > 0)
