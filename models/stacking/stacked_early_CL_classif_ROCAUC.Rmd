...
metric <- metric_set(recall, sensitivity, accuracy) #.784 for roc_auc
...
save(data_test_30, file = 'models/stacking/CL_data_test_30')

# confusion matrix for stacks
caret::confusionMatrix(data_test_30$Cutaneous.Leishmaniasis, 
      data_test_30$.pred_class,
      positive = '1')
...
save(data_test_40, file = 'models/stacking/CL_data_test_40')

# confusion matrix for stacks
caret::confusionMatrix(data_test_40$Cutaneous.Leishmaniasis, 
      data_test_40$.pred_class,
      positive = '1')
...
quantile <- median_data$Cutaneous.Leishmaniasis %>% 
  quantile() 
...
save(data_test_50, file = 'models/stacking/CL_data_test_50')

# confusion matrix for stacks
caret::confusionMatrix(data_test_50$Cutaneous.Leishmaniasis, 
      data_test_50$.pred_class,
      positive = '1')
