...
save(Index_temp, file = 'Index_temp')
data_test_30 <-  (aad %>% 
...
save(svm_res, file = 'base_models/svm_res_early_CL_classif_30')
...
save(xgb_res, file = 'base_models/xgb_res_early_CL_classif_30')
...
save(rf_res, file = 'base_models/rf_res_early_CL_classif_30')
# 
...
save(nb_res, file = 'base_models/nb_res_early_CL_classif_30')
```

Finally, we build our stacked model based on the best performing base model candidates.

```{r}
load(file = 'base_models/svm_res_early_CL_classif_30')
load(file = 'base_models/xgb_res_early_CL_classif_30')
load(file = 'base_models/rf_res_early_CL_classif_30')
load(file = 'base_models/nb_res_early_CL_classif_30')
...
save(data_st_30, file = 'data_stacks/data_st_early_CL_classif_30')
...
save(model_st_30, file = 'model_stacks/model_st_early_CL_classif_30')
load('model_stacks/model_st_early_CL_classif_30')
...
save(data_test_30, file = 'data_tests/data_test_early_CL_classif_30')
...
save(conf_mat_early_CL_classif_30, file = 'confusion_matrices/conf_mat_early_CL_classif_30')
...
save(svm_res, file = 'base_models/svm_res_early_CL_classif_40')
...
save(xgb_res, file = 'base_models/xgb_res_early_CL_classif_40')
# 
...
save(rf_res, file = 'base_models/rf_res_early_CL_classif_40')
# 
...
save(nb_res, file = 'base_models/nb_res_early_CL_classif_40')

load(file = 'base_models/svm_res_early_CL_classif_40')
load(file = 'base_models/xgb_res_early_CL_classif_40')
load(file = 'base_models/rf_res_early_CL_classif_40')
load(file = 'base_models/nb_res_early_CL_classif_40')
...
save(data_st_40, file = 'data_stacks/data_st_early_CL_classif_40')
load('data_stacks/data_st_early_CL_classif_40')
...
save(model_st_40, file = 'model_stacks/model_st_early_CL_classif_40')

load('model_stacks/model_st_early_CL_classif_40')

data_test_40 <-
  data_test_40 %>%
  bind_cols(predict(model_st_40, .))

save(data_test_40, file = 'data_tests/data_test_early_CL_classif_40')
load('data_tests/data_test_early_CL_classif_40')
...
save(conf_mat_early_CL_classif_40, file = 'confusion_matrices/conf_mat_early_CL_classif_40')
...
save(svm_res, file = 'base_models/svm_res_early_CL_classif_50')
...
save(xgb_res, file = 'base_models/xgb_res_early_CL_classif_50')
# 
...
save(rf_res, file = 'base_models/rf_res_early_CL_classif_50')
# 
...
save(nb_res, file = 'base_models/nb_res_early_CL_classif_50')

load(file = 'base_models/svm_res_early_CL_classif_50')
load(file = 'base_models/xgb_res_early_CL_classif_50')
load(file = 'base_models/rf_res_early_CL_classif_50')
load(file = 'base_models/nb_res_early_CL_classif_50')
...
save(data_st_50, file = 'data_stacks/data_st_early_CL_classif_50')
...
save(model_st_50, file = 'model_stacks/model_st_early_CL_classif_50')
load('model_stacks/model_st_early_CL_classif_50')
...
save(data_test_50, file = 'data_tests/data_test_early_CL_classif_50')
...
save(conf_mat_early_CL_classif_50, file = 'confusion_matrices/conf_mat_early_CL_classif_50')
...
save(svm_res, file = 'base_models/svm_res_early_CL_classif_60')
...
save(xgb_res, file = 'base_models/xgb_res_early_CL_classif_60')
# 
...
save(rf_res, file = 'base_models/rf_res_early_CL_classif_60')
# 
...
save(nb_res, file = 'base_models/nb_res_early_CL_classif_60')

load(file = 'base_models/svm_res_early_CL_classif_60')
load(file = 'base_models/xgb_res_early_CL_classif_60')
load(file = 'base_models/rf_res_early_CL_classif_60')
load(file = 'base_models/nb_res_early_CL_classif_60')
...
save(data_st_60, file = 'data_stacks/data_st_early_CL_classif_60')
...
save(model_st_60, file = 'model_stacks/model_st_early_CL_classif_60')
load('model_stacks/model_st_early_CL_classif_60')
...
save(data_test_60, file = 'data_tests/data_test_early_CL_classif_60')
...
save(conf_mat_early_CL_classif_60, file = 'confusion_matrices/conf_mat_early_CL_classif_60')
...
save(svm_res, file = 'base_models/svm_res_early_CL_classif_70')
...
save(xgb_res, file = 'base_models/xgb_res_early_CL_classif_70')
# 
...
save(rf_res, file = 'base_models/rf_res_early_CL_classif_70')
# 
...
save(nb_res, file = 'base_models/nb_res_early_CL_classif_70')

load(file = 'base_models/svm_res_early_CL_classif_70')
load(file = 'base_models/xgb_res_early_CL_classif_70')
load(file = 'base_models/rf_res_early_CL_classif_70')
load(file = 'base_models/nb_res_early_CL_classif_70')
...
save(data_st_70, file = 'data_stacks/data_st_early_CL_classif_70')
...
save(model_st_70, file = 'model_stacks/model_st_early_CL_classif_70')
load('model_stacks/model_st_early_CL_classif_70')
...
save(data_test_70, file = 'data_tests/data_test_early_CL_classif_70')
...
save(conf_mat_early_CL_classif_70, file = 'confusion_matrices/conf_mat_early_CL_classif_70')
...
load(file = 'confusion_matrices/conf_mat_early_CL_classif_30')
load(file = 'confusion_matrices/conf_mat_early_CL_classif_40')
load(file = 'confusion_matrices/conf_mat_early_CL_classif_50')
load(file = 'confusion_matrices/conf_mat_early_CL_classif_60')
load(file = 'confusion_matrices/conf_mat_early_CL_classif_70')
```
...
load(file = 'data_tests/data_test_early_CL_classif_30')
load(file = 'data_tests/data_test_early_CL_classif_40')
load(file = 'data_tests/data_test_early_CL_classif_50')
load(file = 'data_tests/data_test_early_CL_classif_60')
load(file = 'data_tests/data_test_early_CL_classif_70')
...
save(heatmap_aad, file = "heatmaps/heatmap_aad")
...
save(heatmap_mis_40, file = "heatmaps/heatmap_mis_40")
...
save(heatmap_correct_40, file = "heatmaps/heatmap_correct_40")
```

```{r heatmaps, eval=T}
load("heatmaps/heatmap_aad")
load("heatmaps/heatmap_mis_40")
load("heatmaps/heatmap_correct_40")
