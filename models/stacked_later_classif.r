...
# <chr>    <chr>          <dbl> <chr>                  
#   1 accuracy binary         1     Cutaneous.Leishmaniasis
# 2 accuracy binary         0.798 .pred_class            
# 3 accuracy binary         0.794 .pred_class_xgb_res_1_2
# 4 accuracy binary         0.800 .pred_class_xgb_res_1_5
