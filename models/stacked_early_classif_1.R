...
# save(svm_res, file = 'models/stacking/svm_res')
load(file = 'models/stacking/svm_res')
...
# save(xgb_res, file = 'models/stacking/xgb_res')

load(file = 'models/stacking/xgb_res')
...
#   )
# 
# save(rf_res, file = 'models/stacking/rf_res')

load(file = 'models/stacking/rf_res')
