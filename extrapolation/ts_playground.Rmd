...
monthly_short %>% filter(Year == 2018) %>% select(Code) %>% dim()
monthly_short %>% filter(Year == 2019) %>% select(Code) %>% dim()
aad %>% filter(Year == 2018) %>% select(Code) %>% dim()
aad %>% filter(Year == 2019) %>% select(Code) %>% dim()

monthly_short %>% filter(Year %in% c(2018, 2019))

monthly_short %>% filter(Year == 2019) %>% summary()

ggplot(monthly_short %>% 
         filter(Year %in% c(2018,2019))) + 
  geom_boxplot(aes(Code, group = Year))
...
```{r}
# Toy
fit <- auto.arima((monthly_short %>% filter(Year %in% c(2018, 2019)) %>% filter(Code == (monthly_short$Code %>% unique())[k]))[,'Population'], 
                  seasonal=T, 
                  biasadj = T,
                  allowdrift = T,
                  lambda = 'auto')
...
fit <- auto.arima((monthly_short %>% filter(Year != 2019) %>% filter(Code == (monthly_short$Code %>% unique())[k]))[,'Population'], 
                  seasonal=T, 
                  biasadj = T,
                  allowdrift = T,
                  lambda = 'auto')
...
```{r}
# Toy
fit <- auto.arima((monthly_short %>% filter(Year != 2019) %>% filter(Code == (monthly_short$Code %>% unique())[20]))[,'Population'], 
                  seasonal=T, 
                  biasadj = T,
                  allowdrift = T,
                  lambda = 'auto')
...
```{r}
# Toy
fit <- auto.arima((monthly_short %>% filter(Code == (monthly_short$Code %>% unique())[20]))[,'Population'], 
                  seasonal=T, 
                  biasadj = T,
                  allowdrift = T,
                  lambda = 'auto')
...
save(test_rwf_df_9, file = 'complete_projected')
```
