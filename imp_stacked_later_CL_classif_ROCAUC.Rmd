...
save(svm_res, file = 'models/stacking/svm_res_later_CL_classif_30')
...
save(xgb_res, file = 'models/stacking/xgb_res_later_CL_classif_30')
...
save(rf_res, file = 'models/stacking/rf_res_later_CL_classif_30')
# 
...
save(nb_res, file = 'models/stacking/nb_res_later_CL_classif_30')
```

Finally, we build our stacked model based on the best performing base model candidates.

```{r}
load(file = 'models/stacking/svm_res_later_CL_classif_30')
load(file = 'models/stacking/xgb_res_later_CL_classif_30')
load(file = 'models/stacking/rf_res_later_CL_classif_30')
load(file = 'models/stacking/nb_res_later_CL_classif_30')
...
save(data_st_30, file = 'models/stacking/data_st_later_CL_classif_30')
...
save(model_st_30, file = 'models/stacking/model_st_later_CL_classif_30')
...
save(data_test_30, file = 'models/stacking/data_test_later_CL_classif_30')
...
save(conf_mat_later_CL_classif_30, file = 'models/stacking/conf_mat_later_CL_classif_30')
...
save(svm_res, file = 'models/stacking/svm_res_later_CL_classif_40_imp')
...
save(xgb_res, file = 'models/stacking/xgb_res_later_CL_classif_40_imp')
# 
...
save(rf_res, file = 'models/stacking/rf_res_later_CL_classif_40_imp')
# 
...
save(nb_res, file = 'models/stacking/nb_res_later_CL_classif_40_imp')

load(file = 'models/stacking/svm_res_later_CL_classif_40_imp')
load(file = 'models/stacking/xgb_res_later_CL_classif_40_imp')
load(file = 'models/stacking/rf_res_later_CL_classif_40_imp')
load(file = 'models/stacking/nb_res_later_CL_classif_40_imp')
...
save(data_st_40, file = 'models/stacking/data_st_later_CL_classif_40_imp')
load('models/stacking/data_st_later_CL_classif_40_imp')
...
save(model_st_40, file = 'models/stacking/model_st_later_CL_classif_40_imp')

load('models/stacking/model_st_later_CL_classif_40_imp')

data_test_40 <-
  data_test_40 %>%
  bind_cols(predict(model_st_40, .))

save(data_test_40, file = 'models/stacking/data_test_later_CL_classif_40_imp')

load(file = 'models/stacking/data_test_later_CL_classif_40_imp')
# confusion matrix for stacks
...
save(conf_mat_later_CL_classif_40, file = 'models/stacking/conf_mat_later_CL_classif_40_imp')
...
save(svm_res, file = 'models/stacking/svm_res_later_CL_classif_50')
...
save(xgb_res, file = 'models/stacking/xgb_res_later_CL_classif_50')
# 
...
save(rf_res, file = 'models/stacking/rf_res_later_CL_classif_50')
# 
...
save(nb_res, file = 'models/stacking/nb_res_later_CL_classif_50')

load(file = 'models/stacking/svm_res_later_CL_classif_50')
load(file = 'models/stacking/xgb_res_later_CL_classif_50')
load(file = 'models/stacking/rf_res_later_CL_classif_50')
load(file = 'models/stacking/nb_res_later_CL_classif_50')
...
save(data_st_50, file = 'models/stacking/data_st_later_CL_classif_50')
...
save(model_st_50, file = 'models/stacking/model_st_later_CL_classif_50')
...
save(data_test_50, file = 'models/stacking/data_test_later_CL_classif_50')
...
save(conf_mat_later_CL_classif_50, file = 'models/stacking/conf_mat_later_CL_classif_50')
...
save(svm_res, file = 'models/stacking/svm_res_later_CL_classif_60')
...
save(xgb_res, file = 'models/stacking/xgb_res_later_CL_classif_60')
# 
...
save(rf_res, file = 'models/stacking/rf_res_later_CL_classif_60')
# 
...
save(nb_res, file = 'models/stacking/nb_res_later_CL_classif_60')

load(file = 'models/stacking/svm_res_later_CL_classif_60')
load(file = 'models/stacking/xgb_res_later_CL_classif_60')
load(file = 'models/stacking/rf_res_later_CL_classif_60')
load(file = 'models/stacking/nb_res_later_CL_classif_60')
...
save(data_st_60, file = 'models/stacking/data_st_later_CL_classif_60')
...
save(model_st_60, file = 'models/stacking/model_st_later_CL_classif_60')
...
save(data_test_60, file = 'models/stacking/data_test_later_CL_classif_60')
...
save(conf_mat_later_CL_classif_60, file = 'models/stacking/conf_mat_later_CL_classif_60')
