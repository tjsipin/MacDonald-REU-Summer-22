...
knitr::opts_knit$set(root.dir = "\\\\babylon/visitors/tjsipin/Summer_REU/MacDonald-REU-Summer-22")
```
...
# setwd("\\\\babylon/visitors/tjsipin/Summer_REU/MacDonald-REU-Summer-22")
...
cat_df$Cutaneous.Leishmaniasis <- cut(cat_df$Cutaneous.Leishmaniasis,
                                      breaks = c(-1, 0.09154, 0.86616, 10^3), # -1 instead of 0
                                                                               # since noninclusive
